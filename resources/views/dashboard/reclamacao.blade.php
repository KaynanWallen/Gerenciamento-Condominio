...
@section('content')
    <form class="formulario w-100 d-flex flex-wrap justify-content-start gap-3 pt-5 p-3 overflow-auto">
        <div class="d-flex w-100 flex-column ">
            <label class="fs-4 text-input fw-semibold pb-3">Reclamações</label>
        ...
        <div class="w-100">
            <button type="button" class="btn btn-success fw-semibold text-preto text-center mt-5 p-0 fs-5" style=" width:160px; height:50px">Registrar nova</button>
        </div>
    </form>
@endsection